...
export const mysteries: Mystery[] = [
  ...
  { name: 'Puma Punku', lat: -16.56, lng: -68.68, category: 'Ancient Mysteries', summary: 'Part of the Tiwanaku complex in Bolivia, these precisely cut stone blocks date to around 536 CE. The engineering precision baffles modern architects.', slug: 'puma-punku' },
  { name: 'Coral Castle', lat: 25.50, lng: -80.44, category: 'Historical Enigmas', summary: 'Between 1923 and 1951, Edward Leedskalnin single-handedly carved and moved over 1,100 tons of coral rock in Florida. Nobody knows how he did it.', slug: 'coral-castle' },
  { name: 'Georgia Guidestones (former site)', lat: 34.23, lng: -82.89, category: 'Historical Enigmas', summary: 'Erected in 1980 by an anonymous patron, these granite slabs displayed guidelines for humanity in eight languages. They were destroyed in 2022.', slug: 'georgia-guidestones' },
  { name: 'Kecksburg UFO Incident', lat: 40.18, lng: -79.46, category: 'UFOs & UAPs', summary: 'In December 1965, residents of Kecksburg, Pennsylvania witnessed a fireball crash into nearby woods. The military quickly cordoned off the area.', slug: 'kecksburg-ufo-incident' },
  { name: 'Belgian UFO Wave', lat: 50.85, lng: 4.35, category: 'UFOs & UAPs', summary: 'Between 1989 and 1990, thousands of Belgians reported large, silent triangular craft. F-16 jets were scrambled but couldn\'t intercept them.', slug: 'belgian-ufo-wave' },
  { name: 'Tic Tac UFO (USS Nimitz)', lat: 31.0, lng: -118.0, category: 'UFOs & UAPs', summary: 'In 2004, Navy pilots from the USS Nimitz encountered a white, oblong object performing maneuvers far beyond known aircraft capabilities off San Diego.', slug: 'tic-tac-ufo' },
  { name: 'Disappearance of Frederick Valentich', lat: -39.0, lng: 145.0, category: 'Disappearances', summary: 'In 1978, pilot Frederick Valentich disappeared over Bass Strait, Australia after radioing about an unidentified craft hovering above his Cessna.', slug: 'frederick-valentich' },
  { name: 'Flannan Isles Lighthouse', lat: 58.29, lng: -7.59, category: 'Disappearances', summary: 'In December 1900, three lighthouse keepers vanished from the Flannan Isles, Scotland. The clock had stopped and a meal sat uneaten.', slug: 'flannan-isles-lighthouse' },
  { name: 'SS Ourang Medan', lat: 2.0, lng: 108.0, category: 'Ocean Depths', summary: 'In 1947 (or 1948), a Dutch freighter reportedly sent a distress call saying the entire crew was dead. Rescuers allegedly found corpses frozen in terror.', slug: 'ss-ourang-medan' },
  { name: 'Yonaguni Monument', lat: 24.43, lng: 123.01, category: 'Ocean Depths', summary: 'Discovered in 1987 off Japan\'s coast, this underwater rock formation features what appear to be steps, walls, and pillars. Natural or man-made?', slug: 'yonaguni-monument' },
  { name: 'Bimini Road', lat: 25.77, lng: -79.28, category: 'Ocean Depths', summary: 'A half-mile underwater formation of rectangular limestone blocks near the Bahamas, discovered in 1968. Some believe it\'s a road to lost Atlantis.', slug: 'bimini-road' },
  { name: 'Taos Hum', lat: 36.41, lng: -105.57, category: 'Consciousness', summary: 'Since the early 1990s, residents of Taos, New Mexico have reported a persistent low-frequency humming sound. Its source has never been identified.', slug: 'taos-hum' },
  { name: 'Havana Syndrome (US Embassy, Cuba)', lat: 23.11, lng: -82.35, category: 'Consciousness', summary: 'Starting in 2016, US diplomats in Havana reported sudden hearing loss, dizziness, and cognitive difficulties. The cause remains officially unexplained.', slug: 'havana-syndrome' },
  { name: 'Dancing Plague of 1518 (Strasbourg)', lat: 48.57, lng: 7.75, category: 'Consciousness', summary: 'In July 1518, hundreds of people in Strasbourg danced uncontrollably for days. Some reportedly danced until they collapsed or died.', slug: 'dancing-plague-of-1518' },
  { name: 'Overtoun Bridge Dog Leaps', lat: 55.94, lng: -4.57, category: 'Consciousness', summary: 'Since the 1950s, dozens of dogs have inexplicably leapt from Overtoun Bridge near Dumbarton, Scotland. No satisfying explanation has been found.', slug: 'overtoun-bridge-dog-leaps' },
  { name: 'The Hinterkaifeck Murders', lat: 48.13, lng: 11.47, category: 'Historical Enigmas', summary: 'In 1922, six people were murdered on a remote Bavarian farmstead. Days before, the farmer noticed strange footprints in the snow leading to the farm, but none leading away.', slug: 'hinterkaifeck-murders' },
  { name: 'Cicada 3301', lat: 38.90, lng: -77.04, category: 'Historical Enigmas', summary: 'Starting in 2012, an anonymous organization posted complex cryptographic puzzles online to recruit "highly intelligent individuals." Their identity is unknown.', slug: 'cicada-3301' },
  { name: 'Tamam Shud Case', lat: -34.98, lng: 138.53, category: 'Disappearances', summary: 'In 1948, an unidentified man was found dead on Somerton Beach, Adelaide. A scrap of paper in his pocket read "Tamam Shud" (meaning "ended"). His identity remains unknown.', slug: 'tamam-shud-case' },
  { name: 'Lead Masks of Vintem Hill', lat: -22.94, lng: -43.30, category: 'Disappearances', summary: 'In 1966, two electronic technicians were found dead on a hill in Brazil wearing formal suits and crude lead eye masks. A note referenced "capsules" and "wait for the signal."', slug: 'lead-masks-of-vintem-hill' },
  { name: 'Elisa Lam (Cecil Hotel)', lat: 34.04, lng: -118.26, category: 'Disappearances', summary: 'In 2013, 21-year-old Elisa Lam was found in a water tank atop the Cecil Hotel in LA. Elevator surveillance footage showed her behaving strangely before her death.', slug: 'elisa-lam' },
  { name: 'The Wow! Signal Origin (Sagittarius)', lat: 40.33, lng: -83.76, category: 'Space Anomalies', summary: 'Detected in 1977, this narrowband radio signal from deep space lasted 72 seconds and has never repeated. Its origin remains one of SETI\'s greatest puzzles.', slug: 'wow-signal' },
  { name: 'Oumuamua Trajectory', lat: 19.82, lng: -155.47, category: 'Space Anomalies', summary: 'In 2017, the first confirmed interstellar object passed through our solar system. Its unusual acceleration and shape led some scientists to suggest artificial origins.', slug: 'oumuamua' },
  { name: 'Tabby\'s Star (KIC 8462852)', lat: 32.60, lng: -85.49, category: 'Space Anomalies', summary: 'This star dims by up to 22% at irregular intervals. While dust is the likely cause, the "alien megastructure" hypothesis captured public imagination in 2015.', slug: 'tabbys-star' },
  { name: 'Fast Radio Bursts (Arecibo)', lat: 18.34, lng: -66.75, category: 'Space Anomalies', summary: 'First detected in 2007, these millisecond-long radio pulses from deep space repeat unpredictably. Their origins are still being investigated.', slug: 'fast-radio-bursts' },
