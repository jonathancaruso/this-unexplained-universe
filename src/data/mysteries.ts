...
export const mysteries: Mystery[] = [
  ...
  { name: 'Area 51', lat: 37.24, lng: -115.81, category: 'UFOs & UAPs', summary: 'A highly classified US Air Force facility in Nevada. Its secrecy has fueled decades of speculation about reverse-engineered alien technology.', slug: null },
  ...
  { name: 'Phoenix Lights', lat: 33.45, lng: -112.07, category: 'UFOs & UAPs', summary: 'On March 13, 1997, thousands of witnesses across Arizona reported a massive V-shaped formation of lights gliding silently overhead.', slug: null },
  { name: 'Hessdalen Lights', lat: 62.83, lng: 11.07, category: 'UFOs & UAPs', summary: 'Since the 1980s, unexplained lights have appeared in Norway\'s Hessdalen valley. Scientists have documented them but can\'t fully explain the phenomenon.', slug: null },
  { name: 'Marfa Lights', lat: 30.31, lng: -104.02, category: 'UFOs & UAPs', summary: 'Mysterious glowing orbs have been spotted near Marfa, Texas since the 1880s. Explanations range from atmospheric mirages to swamp gas.', slug: null },
  { name: 'Amelia Earhart Last Position', lat: 2.62, lng: -174.52, category: 'Disappearances', summary: 'In 1937, Amelia Earhart disappeared over the Pacific during her attempt to circumnavigate the globe. Her plane and remains have never been confirmed found.', slug: null },
  { name: 'Jack the Ripper (Whitechapel)', lat: 51.52, lng: -0.07, category: 'Historical Enigmas', summary: 'In 1888, at least five women were murdered in London\'s Whitechapel district by an unidentified killer. Over 100 suspects have been proposed.', slug: null },
  { name: 'Zodiac Killer (San Francisco)', lat: 37.77, lng: -122.42, category: 'Historical Enigmas', summary: 'Between 1968 and 1969, the Zodiac Killer murdered at least five people in Northern California. He taunted police with coded letters and was never caught.', slug: null },
  { name: 'Machu Picchu', lat: -13.16, lng: -72.55, category: 'Ancient Mysteries', summary: 'This 15th-century Incan citadel sits 7,970 feet above sea level in the Andes. Its exact purpose, whether royal estate, temple, or observatory, is still debated.', slug: null },
  { name: 'Gobekli Tepe', lat: 37.22, lng: 38.92, category: 'Ancient Mysteries', summary: 'Built around 9500 BCE in southeastern Turkey, this is the world\'s oldest known temple. It predates agriculture, challenging theories of civilization\'s origins.', slug: null },
  { name: 'Angkor Wat', lat: 13.41, lng: 103.87, category: 'Ancient Mysteries', summary: 'The largest religious monument ever built, constructed in the 12th century in Cambodia. Its hydraulic engineering was centuries ahead of its time.', slug: null },
  { name: 'Teotihuacan', lat: 19.69, lng: -98.84, category: 'Ancient Mysteries', summary: 'This massive pre-Aztec city near Mexico City once housed 125,000 people. We still don\'t know who built it or why it was abandoned around 550 CE.', slug: null },
